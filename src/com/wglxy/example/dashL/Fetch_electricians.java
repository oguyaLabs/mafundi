...
public class Fetch_electricians  extends DashboardActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
	           ...
	           httppost = new HttpPost("http://10.0.2.2/mafundidatabase/electricians.php");
...
//	   				
	   				...
	   				myListView.setOnItemClickListener(new OnItemClickListener() {
						...
						public void onItemClick(AdapterView<?> arg0, View arg1,
                            ...
                            //String email="yess";
							Intent intent = new Intent(Fetch_electricians.this, ElectricianCall.class);
