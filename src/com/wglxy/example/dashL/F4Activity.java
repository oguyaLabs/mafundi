...
/**
 * This is the activity for feature 4 in the dashboard application. It displays
 * some text and provides a way to get back to the home activity.
 * 
 */

public class F4Activity extends DashboardActivity implements OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		CompanyListAdapter.Inflater inflater = new Inflater(4);
